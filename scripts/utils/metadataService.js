...
# 出力形式 (JSONのみ、コードブロックなし)
{
  ...
  "faq": [
    {"question": "読者が実際に検索しそうな質問1（テーマに直結）", "answer": "簡潔で実用的な回答（80〜120文字程度）"},
    {"question": "読者が実際に検索しそうな質問2", "answer": "簡潔で実用的な回答（80〜120文字程度）"},
    {"question": "読者が実際に検索しそうな質問3", "answer": "簡潔で実用的な回答（80〜120文字程度）"}
  ],
  "body": [
