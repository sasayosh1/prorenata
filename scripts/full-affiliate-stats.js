...
async function checkAllAffiliate() {
  const line = '='.repeat(60)
  console.log(line)
  console.log('📊 全記事アフィリエイトリンク設置状況')
  console.log(line)
  console.log()
  ...
  posts.forEach(post => {
    ...
    if (hasAmazon || hasRakuten || hasA8) postsWithAnyAffiliate++
  ...
  const totalAffiliateLinks = totalAmazonLinks + totalRakutenLinks + totalA8Links
...
checkAllAffiliate().catch(console.error)
