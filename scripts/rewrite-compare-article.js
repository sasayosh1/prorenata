...
async function main() {
  ...
  body.push(...ctaWithEmbed('humanlifecare', '[PR] 教育制度まで丁寧に確認してほしいときは、ヒューマンライフケアに希望条件を預けてみてください。 ヒューマンライフケアの求人サポートを見る', 'ヒューマンライフケアの特徴'))
  ...
  body.push(...ctaWithEmbed('renewcare', '[PR] 関西圏や都市部で交渉を任せたいなら、リニューケアに希望の夜勤回数や給与レンジを整理して伝えると調整がスムーズです。 リニューケアの転職支援に相談する', 'リニューケアの特徴'))
  ...
  body.push(...ctaWithEmbed('kaigobatake', '[PR] 無資格・未経験からじっくり準備したい場合は、かいご畑の資格支援付き求人をチェックしてみてください。 かいご畑で介護職・看護助手の求人を探す', 'かいご畑の特徴'))
  ...
  body.push(...ctaWithEmbed('humanlifecare', '[PR] 全国の医療法人や老健を幅広く比較したい方は、ヒューマンライフケアの担当者に教育体制や福利厚生の条件をまとめて確認してもらいましょう。 ヒューマンライフケアの求人サポートを見る', 'まとめ後CTA'))
  body.push(...ctaWithEmbed('renewcare', '[PR] 夜勤回数や給与交渉をしっかり進めたい方は、リニューケアに希望条件を整理して共有してください。 リニューケアの転職支援に相談する', 'まとめ後CTA'))
  body.push(...ctaWithEmbed('kaigobatake', '[PR] 無資格・未経験からキャリアを積みたい方は、かいご畑で資格支援付き求人をチェックしてみてください。 かいご畑で介護職・看護助手の求人を探す', 'まとめ後CTA'))
