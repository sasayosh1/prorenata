...
async function main() {
  ...
  body.push(block('ここまでで全体像と個別の強みを押さえられました。気になる点があれば、担当者に直接質問できるようメモを残し、どのサービスに何を任せたいかを明確にしておきましょう。'))
  ...
  body.push(block('このように契約タイプが違うため、「まずは派遣で経験を積む」「初めから正社員で腰を据える」など、自分のステップに合わせて相談先を選ぶことが大切です。'))
  ...
  body.push(block('担当者とこまめに状況を共有しておくことで、夜勤前後の連絡や契約更新時のサポートがスムーズになります。「いま何に困っているか」を遠慮なく伝える姿勢が、より良い提案につながります。'))
  ...
  body.push(block('自分の希望を整理したうえで、「どのサービスに何を任せるか」を決めておくと、面談で聞きたいことが明確になります。複数の窓口を併用しながら、最も相性の良い担当者を探しましょう。'))

  body.push(heading('６．利用者の声とよくある質問'))
  body.push(block('実際にサービスを利用した看護助手の声や、よく届く質問をまとめました。不安に感じやすいポイントを事前に把握しておくと、面談で遠慮なく相談できます。'))
  body.push(
  ...
  body.push(block('心配ごとがあれば、面談の場だけでなくチャットや電話でも相談できます。遠慮せず質問を重ねることが、納得できる転職活動につながります。'))
