...
const body = [
  ...
  block('料金: 16,500円（税込）。弁護士が直接対応し、未払賃金やハラスメント交渉も相談可。医療・介護の実績が多く、書類や有休消化にも配慮。'),
  block('退職代行 即ヤメ（スピード・24時間相談）', 'h3'),
  block('料金: 15,000円（税込）。LINEで24時間相談でき、即日退職を目指しやすい。連絡を自分で取りたくない人、夜間相談したい人向け。'),
  block('弁護士法人ガイア法律事務所（医療介護の相談実績）', 'h3'),
  block('料金: 14,000円（税込）。医療・介護案件の経験が多く、就業規則や引き継ぎ手順にも配慮。LINE/メール相談で進めやすい。'),
  block('推奨理由（公平・中立）', 'h3'),
