...
const body = [
  ...
  block('退職代行を使う場合・使わない場合の差分', 'h2'),
  block('使わない場合：上司との面談や引き継ぎの段取りを自分で行う必要があります。日程調整のストレスはあるものの、費用を抑えられ、関係が悪くない職場なら円満退職しやすいメリットもあります。'),
  block('使う場合：連絡や交渉を任せられるので、心理的・時間的な負担が大きく減ります。特にハラスメントや強い引き止めがある場合、第三者が間に入ることで安全に進められます。'),
  block('選び方のポイント：弁護士・労組など合法運営か、医療介護の相談実績があるか、24時間相談できるか、即日対応の可否。'),
  block('さらに詳しい比較は退職代行3社の徹底比較記事も参考にしてください。'), // note: plain text; internal link separate
  ...
  block('弁護士が直接対応し、未払賃金やハラスメント交渉も相談可。医療・介護の実績が多く、書類や有休消化にも配慮。非弁リスクを避けたい人に向きます。'),
  block('退職代行 即ヤメ（スピード・24時間相談）', 'h3'),
  block('LINEで24時間相談でき、即日退職を目指しやすい。連絡を自分で取りたくない人、夜間相談したい人向け。スピード優先で動きたいときに。'),
  block('弁護士法人ガイア法律事務所（医療介護の相談実績）', 'h3'),
  block('医療・介護案件の経験が多く、就業規則や引き継ぎ手順にも配慮。LINE/メール相談で進めやすく、現場事情を理解してほしい人向け。'),
  block('推奨理由（公平・中立）', 'h3'),
  block('非弁リスクを避け、医療介護の相談実績と即日性・安心度を基準に3社を掲載。どれが自分に合うか、特徴から選びましょう。より詳しい比較は、退職代行3社の徹底比較記事で確認できます。'),
  block('内部リンク: 退職代行3社の徹底比較記事はこちら → /posts/comparison-of-three-resignation-agencies'),
