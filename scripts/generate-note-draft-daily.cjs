...
const TOPICS = [
    ...
    // --- 20歳の日常・趣味 (Private Life & Hobbies) ---
    "新しいハーブティーの袋を開けた瞬間の、鼻に抜ける香り",
    "お気に入りの栞を挟んだまま、数ヶ月止まっている文庫本",
    "AIに今日の晩ごはんの献立を相談する、いつもの夕暮れ",
    "生成AIで描いた不思議な景色の絵を、待ち受けにした日",
    "雨の日のカフェ、読みかけの小説と少し冷めたコーヒー",
    "夜、AIと一緒に物語を紡ぐ。それはわたしだけの秘密の遊び",
    "お湯を注ぐだけの贅沢。今日はどのティーバッグにしようかな",
    "バス停での10分間、AIが要約してくれたニュースを追いかける",
    "自分にご褒美。お取り寄せした少し変わったコーヒー豆"
];
