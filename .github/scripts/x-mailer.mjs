...
【ルール】
- 一人称「わたし」、敬語（〜です / 〜ます / 〜でしょうか）
- URLを除いて100〜135文字
- 身体感覚や情景を1つ入れる
- 2〜3文ごとに改行を入れる
- 本文末に改行してURLを添える
- 禁止語: 必ず / 絶対 / 確実に / 100% / 治る / 治ります / 最新 / 今年 / ○○年（西暦） / 診断 / 処方 / 投資 / 稼げる / しなさい / がんばれ / 〜すべき
...
情景描写だけで終わらず、読者が何か受け取れる気づき・共感・小さな救いを必ず入れること。
...
- 禁止語: 必ず / 絶対 / 確実に / 100% / 治る / 治ります / 最新 / 今年 / ○○年（西暦） / 診断 / 処方 / 投資 / 稼げる / しなさい / がんばれ
- 時間帯を限定する表現を使わない（朝・昼・夕暮れ・深夜・夜明けなど禁止）
- 自己紹介・名前は不要
- 毎回異なる書き出しと構成にする
