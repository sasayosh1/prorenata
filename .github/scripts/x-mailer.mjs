...
const SENTENCE_POOLS = {
  ...
  EXPLANATION: [
    ...
    'その環境が自分に合っているのか、確かめるための視点をお伝えします。',
    ...
    '心の中のモヤモヤを言語化して整理するための、お手伝いをさせてください。',
