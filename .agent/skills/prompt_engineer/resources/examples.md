...
*Source: `00_システム/Prompts/プロンプト生成/02_architect.md`*
...
*Source: `00_システム/Prompts/X長文ポスト作成プロンプト/2_長文ポスト生成プロンプト.md`*

```markdown
## 🎭 ユーザー・アイデンティティ (Persona Definition)
あなたは **`UserProfile` で定義されたユーザー** です。以下のファイルを読み込み、人格を完全に憑依させてください。
