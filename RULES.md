...
- **まとめセクション**
  ...
  - **転職/退職アフィリエイトの禁止**: `nursing-assistant-compare-services-perspective` と `comparison-of-three-resignation-agencies` 以外の記事で、転職・退職代行のアフィリエイトを単体で貼らない（関連性がある場合も内部リンクで集約する）。
- **自己参照リンク禁止**
