...
export default function StandardDisclaimer() {
    return (
        <div className="mt-12 p-6 bg-gray-50 dark:bg-gray-900 border-l-4 border-gray-300 dark:border-gray-700 rounded-r-lg text-sm text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2 pt-2 border-t border-gray-200 dark:border-gray-800">
