...
export const medicalTerms: MedicalTerm[] = [
  ...
  {
    id: 'body-temperature-check-2',
    term: '体温測定',
    reading: 'たいおんそくてい',
    meaning: '体温を測ること。',
    distractors: ['血圧測定', '呼吸回数測定', '脈拍測定'],
    category: 'vital-signs',
    difficulty: 1
  },
  {
    ...
    term: '注射（ちゅうしゃ）',
    reading: 'ちゅうしゃ',
    meaning: '薬剤を注射器で体内に注入すること。',
    distractors: ['点滴（てんてき）', '吸入（きゅうにゅう）'],
    category: 'medication',
    difficulty: 1
  },
  {
  ...
  },
  {
    ...
    term: '輸液ポンプ',
    reading: 'ゆえきぽんぷ',
    meaning: '点滴の滴下速度を一定に保つための医療機器。',
    distractors: ['吸引カテーテル', '酸素マスク', '体温計'],
    category: 'equipment',
    difficulty: 1
  },
  {
    id: 'body-temperature-check-3',
    term: '体温測定',
    reading: 'たいおんそくてい',
    meaning: '体温を測ること。発熱や低体温の有無を評価するために行う。',
    distractors: ['血圧測定', '呼吸回数測定'],
    category: 'vital-signs',
    difficulty: 1
  },
  {
  ...
  },
  {
    ...
    term: '輸液ポンプ',
    reading: 'ゆえきぽんぷ',
    meaning: '点滴の速度を一定に保つための医療機器。',
    distractors: ['吸引器', 'パルスオキシメーター', 'カテーテル'],
    category: 'equipment',
    difficulty: 1
  },
  {
    id: 'body-temperature-check-4',
    term: '体温測定',
    reading: 'たいおんそくてい',
  ...
  },
  {
    ...
    reading: 'よやく',
    meaning: '薬剤を患者に投与すること。',
    distractors: ['食事介助', '体位変換'],
    category: 'medication',
    difficulty: 1
  },
  {
    id: 'member-upper-limb',
    term: '上肢（じょうし）',
    reading: 'じょうし',
    meaning: '腕全体のこと。肩から手先までの部分を指します。',
    distractors: ['下肢', '体幹'],
    category: 'anatomy',
    difficulty: 1
  },
  {
    ...
    term: '輸液ポンプ',
    reading: 'ゆえきぽんぷ',
    meaning: '点滴の速度や量を一定に保つための医療機器。',
    distractors: ['吸引器', 'パルスオキシメーター', 'カテーテル'],
    category: 'equipment',
    difficulty: 1
  },
  {
    id: 'body-temperature-check-5',
    term: '体温測定',
    reading: 'たいおんそくてい',
    meaning: '体温を測ること。体温計を用いて、腋窩、口腔、直腸などで測定する。',
    distractors: ['血圧測定', '脈拍測定'],
  ...
  {
    id: 'dressing-change-2',
    term: '創処置',
    reading: 'そうしょち',
    meaning: '創傷（傷）の処置をすること。創部の洗浄、消毒、ガーゼ交換などを行う。',
    distractors: ['バイタル測定', '体位変換'],
    category: 'procedures',
    difficulty: 1
  },
  ...
  {
    id: 'medication-preparation-2',
    term: '与薬準備',
    reading: 'よやくじゅんび',
    meaning: '患者に薬を投与する前に、薬の種類、量、投与方法などを確認し、準備すること。',
    distractors: ['バイタルサイン測定', '食事介助', '体位変換'],
    category: 'medication',
    difficulty: 1
  },
  ...
  {
    id: 'iv-pump-setting-3',
    term: '輸液ポンプ',
    reading: 'ゆえきぽんぷ',
    meaning: '点滴の速度や量を正確に管理する医療機器。',
    distractors: ['吸引器', 'パルスオキシメーター'],
    category: 'equipment',
    difficulty: 1
  },
  {
    id: 'dressing-change-3',
    term: '創処置',
    reading: 'そうしょち',
    meaning: '創傷（傷）の処置をすること。具体的には、ガーゼ交換や消毒などを行う。',
    distractors: ['点滴交換', '導尿カテーテル挿入'],
    category: 'procedures',
    difficulty: 1
  },
  {
    id: 'body-temperature-check-9',
    term: '体温測定',
    reading: 'たいおんそくてい',
    meaning: '体温計を用いて、体温を測ること。',
    distractors: ['血圧測定', '脈拍測定'],
  ...
  },
  {
    ...
    term: '輸液ポンプ',
    reading: 'ゆえきぽんぷ',
    meaning: '点滴を一定の速度で注入するための医療機器',
    distractors: ['吸引カテーテル', '酸素マスク', '体温計'],
    category: 'equipment',
    difficulty: 1
  },
  {
    id: 'dressing-change-4',
    term: '創処置',
    reading: 'そうしょち',
    meaning: '創傷（傷）の処置をすること。創部の洗浄、消毒、被覆材の交換など。',
    distractors: ['バイタル測定', '体位変換', '点滴交換'],
    category: 'procedures',
    difficulty: 1
  },
  {
  ...
  {
    id: 'member-of-lower-limb',
    term: '下肢（かし）',
    reading: 'かし',
    meaning: '足全体を指す言葉。具体的には、股関節から足先までの部分を指します。',
    distractors: ['上肢（じょうし）', '体幹（たいかん）'],
    category: 'anatomy',
    difficulty: 1
  },
  {
    id: 'iv-pump-setting-4',
    term: '輸液ポンプ',
    reading: 'ゆえきぽんぷ',
    meaning: '点滴の滴下速度を一定に保つための医療機器。',
    distractors: ['吸引器', 'パルスオキシメーター', 'カテーテル'],
